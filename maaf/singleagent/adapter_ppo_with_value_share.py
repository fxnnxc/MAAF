...
class MessageAdaptedAgentWithValueShare(CommonPPOModule):
    def __init__(self, backbone_type, 
        ...
        self.base_backbone_critic = make_backbone(backbone, in_features*num_agents, proj_dim, no_final_act)
    ...
    def set_adapter_mode(self, condition):
        if condition:
